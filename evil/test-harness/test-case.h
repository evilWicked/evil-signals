...
public:
	...
	//CTestCase() = default;
	~CTestCase() = default;
	CTestCase(const CTestCase& rhs) = delete;
	CTestCase& operator=(const CTestCase& rhs) = delete;
	CTestCase(CTestCase&& other) = delete;
	CTestCase& operator=(CTestCase&& other) = delete;
};
