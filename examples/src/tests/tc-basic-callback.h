...
Tests.add("Basic Callback", [](evil::TestHarness *th,std::string& result)mutable->bool {

		bool failed = false;
		//create a signal
		evil::Signal<int, double, std::string&> Asig("Asig");
		//create a slot
		evil::Slot<int, double, std::string&> Aslt("Aslt");
		...
		if (iTestVal != 10 || dTestVal!=3.3 || str!="got here") {
			failed = true;
